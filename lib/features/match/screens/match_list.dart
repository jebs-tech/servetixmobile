...
import 'package:servetixmobile/features/match/widgets/match_card.dart';
import 'package:servetixmobile/features/match/models/match_entry.dart';
import 'package:servetixmobile/features/match/screens/match_form.dart';
import 'package:provider/provider.dart';
import 'package:pbp_django_auth/pbp_django_auth.dart';
import '../../matches/presentation/match_detail_page.dart';
...
class _MatchListPageState extends State<MatchListPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // ============== PERUBAHAN UTAMA ==============
      // [SEBELUM]: body: _isLoading ? ... (tanpa gradient)
      // [SETELAH]: Membungkus body dengan Container yang memiliki gradient
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Color(0xFFFADF95), // #FADF95 (kuning muda) - sama dengan Django
              Colors.white,       // #FFFFFF (putih) - sama dengan Django
            ],
          ),
        ),
        child: _isLoading
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => MatchDetailPage(
                          matchId: match.id,  // Kirim data match
                        ),
                      ),
                    );
